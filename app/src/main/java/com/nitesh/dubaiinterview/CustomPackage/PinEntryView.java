...
public class PinEntryView extends TypefacedEditText {
    ...
    public PinEntryView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public void setMask(String mMask) {
        if (mMask != null && mMask.trim().isEmpty())
            mMask = getContext().getString(R.string.filledCircleMask);
        this.mMask = mMask;
        invalidate();
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        super.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                PinEntryView.this.setSelection(PinEntryView.this.getText().length());
