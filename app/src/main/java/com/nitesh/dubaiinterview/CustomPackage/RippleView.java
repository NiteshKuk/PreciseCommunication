...
public class RippleView extends RelativeLayout {
    ...
    // @PKJuly19 07:02 PM IST
    // To avoid performing action in onRippleCompleteListener in LongPress scenario
...
//    private CommonUtils commonUtils;
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, Color.parseColor("#80ffffff"));
...
//        commonUtils = new CommonUtils(context);
        gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public void onLongPress(MotionEvent event) {
                //showLog("GESTURE", " long press " + event.getAction());
                longPress = true;
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                longPress = false;
                animateRipple(e);
                //showLog("GESTURE", " Single Tap " + e.getAction());
                return true;
            }
            ...
            public boolean onSingleTapUp(MotionEvent e) {
                longPress = false;
                animateRipple(e);
                //showLog("GESTURE", " Single Tap Up " + e.getAction());
                return true;
            }
        });
        ...
        try {
            if (animationRunning) {
                ...
                if (rippleDuration <= timer * frameRate) {
                    ...
                    invalidate();
                    if (onCompletionListener != null && !longPress)
